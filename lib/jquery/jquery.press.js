...
module.exports = function(activation_time, distance) {
	...
	var selector = selectPressActivationTimer(activation_time, move, distance);
	var press = down.selectMany(selector);
	
	return press.doAction(
...
function selectPressActivationTimer(activation_time, move, distance) {
